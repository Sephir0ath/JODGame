...
public class RotatedIcon implements Icon
{
    ...
    private Icon icon;
    private ImageIcon imageIcon; // -> Solo para obtener imagen
...
//
    ...
    public void paintIcon(Component c, Graphics g, int x, int y)
    {
        ...
        int cWidth = originalWidth / 2;
        int cHeight = originalHeight / 2;
        int xAdjustment = (originalWidth % 2) == 0 ? 0 : -1;
        int yAdjustment = (originalHeight % 2) == 0 ? 0 : -1;
